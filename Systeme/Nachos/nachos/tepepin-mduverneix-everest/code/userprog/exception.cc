		...
		case SC_GetString:
		  {
		    ...
		    if (machine->ReadRegister(5) > MAX_STRING_SIZE)
		...
		case SC_ThreadCreate:
		  {
		    ...
		    int returnValue = do_ThreadCreate(machine->ReadRegister(4), machine->ReadRegister(5));
		...
		case SC_ForkExec:
		  {
		    ...
		    char *tampon = (char *) malloc(sizeof(char) * MAX_STRING_SIZE);

		    int addrFilename = machine->ReadRegister(4);

		    copyStringFromMachine(addrFilename, tampon, MAX_STRING_SIZE);
